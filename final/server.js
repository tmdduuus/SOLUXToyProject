...
app.post('/register', function(req, res){
    ...
    var tosave = { email : req.body.email, password : req.body.password, personname : req.body.personname, birth : req.body.birth, gender : req.body.gender, phone1 : req.body.phone1, phone2 : req.body.phone2, phone3 : req.body.phone3, area : req.body.area }
...
app.put('/signupedit', function(req, res){
    ...
    var setinfo = { email : req.body.email, password : req.body.password, personname : req.body.personname, birth : req.body.birth, gender : req.body.gender, phone1 : req.body.phone1, phone2 : req.body.phone2, phone3 : req.body.phone3, area : req.body.area }
